...
CREATE TABLE `ingredients` (
  ...
  CONSTRAINT `recipie_ing_fk` FOREIGN KEY (`recipe_id`, `variation_id`) REFERENCES `recipes` (`recipe_id`, `variation_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `steps` (
  ...
  CONSTRAINT `recipie_steps_fk` FOREIGN KEY (`recipe_id`, `variation_id`) REFERENCES `recipes` (`recipe_id`, `variation_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-08-11 20:58:47
